...
export default function ServiceOverlay({
  ...
  const copyToClipboard = async (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    try {
      await navigator.clipboard.writeText(selectedMenu.link);
  ...
  return (
    <div className="flex flex-col gap-4 py-4">
      ...
      <div className="flex flex-col gap-4 w-full">
        <label className="text-base lg:text-xl font-semibold text-primText">
          {serviceName} {selectedMenu.name} Menu Link
        </label>
      ...
      <div className="flex flex-col gap-4 w-full">
        <label className="text-base lg:text-xl font-semibold text-primText">
        {serviceName} {selectedMenu.name} Digital Menu QR Code Settings
        </label>
