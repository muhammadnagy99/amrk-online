  ...
  return (
    <>
      <Overlay isVisible={overlayVisible} onClose={hideOverlay}>
        <TableOverlay tableId={tableId} tableName={tableName} menuLink={menuLink} qrSizes={qrSizes} qrSrcBaseUrl={qrSrcBaseUrl} />
      </Overlay>

      <div className="flex flex-row w-full justify-between">
        <p className="text-sm lg:text-base text-primText font-normal">{tableName}</p>
