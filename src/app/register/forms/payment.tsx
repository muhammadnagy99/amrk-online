...
export default function Payment({onNext}: props) {
  ...
  return (
    <form className="w-full flex flex-col gap-4 lg:gap-6">
      <div className="w-full flex flex-col gap-4">
        ...
        {currentStep === 1 && <PaymentInfo onAccept={handleChangeAccept} state={paymentAccept}/>}
        {currentStep === 2 && paymentAccept && <DineIn onChange={handleChangeDineIn} />}
        {currentStep === 3 && paymentAccept && <LegalInfo onChange={handleBankData} />}
      </div>
